...
class __TwigTemplate_0b135d79028aac3bceadfd529750311372f8780a37d31e88922d11d5b147012d extends Twig_Template
{
    ...
    <form class=\"center\" action=\"";
        ...
        <div class=\"form_quantite\">
            ";
        // line 12
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "message", array()), 'row', array("attr" => array("class" => "u-full-width")));
        echo "
        </div>
        <div class=\"form_quantite\">
            ";
        // line 15
        echo $this->env->getExtension('form')->renderer->searchAndRenderBlock($this->getAttribute((isset($context["form"]) ? $context["form"] : null), "quantite", array()), 'row');
        echo "
        </div>
        ";
        // line 17
