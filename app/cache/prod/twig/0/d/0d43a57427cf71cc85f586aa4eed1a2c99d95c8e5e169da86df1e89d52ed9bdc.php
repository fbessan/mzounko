...
class __TwigTemplate_0d43a57427cf71cc85f586aa4eed1a2c99d95c8e5e169da86df1e89d52ed9bdc extends Twig_Template
{
    ...
    <div class=\"container\" id=\"reponse\">
        <h3 class=\"center\">";
        // line 52
        echo twig_escape_filter($this->env, twig_length_filter($this->env, $this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "reponse", array())), "html", null, true);
        echo " réponse(s) à l'annonce #00";
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "id", array()), "html", null, true);
        echo " </h3>
      <dl class=\"dix_derniers\">
        ";
        // line 54
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, $this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "reponse", array())));
        foreach ($context['_seq'] as $context["_key"] => $context["elt"]) {
            echo "  
            ...
            echo twig_escape_filter($this->env, ($this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "prixunitaire", array()) * $this->getAttribute($context["elt"], "quantite", array())), "html", null, true);
            ...
            echo " ";
            if (($this->getAttribute($this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "categorie", array()), "unite", array()) == "Unité(s)")) {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "categorie", array()), "unite", array()), "html", null, true);
                echo "(s) ";
            } else {
                echo " ";
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "categorie", array()), "unite", array()), "html", null, true);
      ...
      <br/>
        ...
        // line 66
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("NucleusHomeBundle_reponse", array("id" => $this->getAttribute((isset($context["annonce"]) ? $context["annonce"] : null), "id", array()))), "html", null, true);
