...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/reponse')) {
            ...
            if (preg_match('#^/reponse/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'NucleusHomeBundle_reponse')), array (  '_controller' => 'Nucleus\\HomeBundle\\Controller\\HomeController::reponseAction',));
            }

            // NucleusHomeBundle_reponses
            if (0 === strpos($pathinfo, '/reponses') && preg_match('#^/reponses/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'NucleusHomeBundle_reponses')), array (  '_controller' => 'Nucleus\\HomeBundle\\Controller\\HomeController::reponsesAction',));
            }
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'NucleusHomeBundle_home');
            }

            return array (  '_controller' => 'Nucleus\\HomeBundle\\Controller\\HomeController::homeAction',  '_route' => 'NucleusHomeBundle_home',);
        }

        if (0 === strpos($pathinfo, '/login')) {
            // login
            if ($pathinfo === '/login') {
                return array (  '_controller' => 'Application\\Sonata\\UserBundle\\Controller\\SecurityController::loginAction',  '_route' => 'login',);
            }
        ...
        // NucleusHomeBundle_list
        if (preg_match('#^/(?P<_locale>en|fr)/list$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'NucleusHomeBundle_list')), array (  '_controller' => 'Nucleus\\HomeBundle\\Controller\\HomeController::homeAction',));
        }

        // user_home
        if ($pathinfo === '/user/home') {
            return array (  '_controller' => 'NucleusUserBundle:Home:home',  '_route' => 'user_home',);
        }
        ...
        if (0 === strpos($pathinfo, '/admin')) {
            ...
            if (0 === strpos($pathinfo, '/admin/nucleus/home/departement')) {
                // admin_nucleus_home_departement_list
                if ($pathinfo === '/admin/nucleus/home/departement/list') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::listAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_list',  '_route' => 'admin_nucleus_home_departement_list',);
                }

                // admin_nucleus_home_departement_create
                if ($pathinfo === '/admin/nucleus/home/departement/create') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::createAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_create',  '_route' => 'admin_nucleus_home_departement_create',);
                }

                // admin_nucleus_home_departement_batch
                if ($pathinfo === '/admin/nucleus/home/departement/batch') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::batchAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_batch',  '_route' => 'admin_nucleus_home_departement_batch',);
                }

                // admin_nucleus_home_departement_edit
                if (preg_match('#^/admin/nucleus/home/departement/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_nucleus_home_departement_edit')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::editAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_edit',));
                }

                // admin_nucleus_home_departement_delete
                if (preg_match('#^/admin/nucleus/home/departement/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_nucleus_home_departement_delete')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::deleteAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_delete',));
                }

                // admin_nucleus_home_departement_show
                if (preg_match('#^/admin/nucleus/home/departement/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'admin_nucleus_home_departement_show')), array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::showAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_show',));
                }

                // admin_nucleus_home_departement_export
                if ($pathinfo === '/admin/nucleus/home/departement/export') {
                    return array (  '_controller' => 'Sonata\\AdminBundle\\Controller\\CRUDController::exportAction',  '_sonata_admin' => 'sonata.admin.departement',  '_sonata_name' => 'admin_nucleus_home_departement_export',  '_route' => 'admin_nucleus_home_departement_export',);
                }
