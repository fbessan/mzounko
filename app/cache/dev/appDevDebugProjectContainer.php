...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'sonata.admin.departement' => 'getSonata_Admin_DepartementService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => NULL, 'dbname' => 'mzounko', 'user' => 'root', 'password' => 'bescofab', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_1be0f16c7cd58b83d0c5be8afef6d8a2');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_1be0f16c7cd58b83d0c5be8afef6d8a2');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_1be0f16c7cd58b83d0c5be8afef6d8a2');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedXmlDriver(array(($this->targetDirs[3].'/vendor/sonata-project/user-bundle/Resources/config/doctrine') => 'Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/src/Application/Sonata/UserBundle/Resources/config/doctrine') => 'Application\\Sonata\\UserBundle\\Entity', ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/doctrine') => 'FOS\\UserBundle\\Entity'));
        ...
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Nucleus/HomeBundle/Entity'))), 'Nucleus\\HomeBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('SonataUserBundle' => 'Sonata\\UserBundle\\Entity', 'ApplicationSonataUserBundle' => 'Application\\Sonata\\UserBundle\\Entity', 'FOSUserBundle' => 'FOS\\UserBundle\\Entity', 'NucleusHomeBundle' => 'Nucleus\\HomeBundle\\Entity'));
    ...
    /**
     * Gets the 'sonata.admin.departement' service.
     *
     * @return \Nucleus\HomeBundle\Admin\DepartementAdmin A Nucleus\HomeBundle\Admin\DepartementAdmin instance.
     */
    protected function getSonata_Admin_DepartementService()
    {
        $instance = new \Nucleus\HomeBundle\Admin\DepartementAdmin('sonata.admin.departement', 'Nucleus\\HomeBundle\\Entity\\Departement', 'SonataAdminBundle:CRUD');
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.departement', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.admin.departement')), 'sonata_user' => array('label' => 'sonata_user', 'label_catalogue' => 'SonataUserBundle', 'icon' => '<i class="fa fa-folder"></i>', 'roles' => array(), 'items' => array(0 => 'sonata.user.admin.user', 1 => 'sonata.user.admin.group'))));
        $instance->setAdminClasses(array('Nucleus\\HomeBundle\\Entity\\Departement' => array(0 => 'sonata.admin.departement'), 'Application\\Sonata\\UserBundle\\Entity\\User' => array(0 => 'sonata.user.admin.user'), 'Application\\Sonata\\UserBundle\\Entity\\Group' => array(0 => 'sonata.user.admin.group')));
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.departement', 1 => 'sonata.user.admin.user', 2 => 'sonata.user.admin.group'), $this);
    }
    ...
    /**
     * Gets the 'sonata.user.authentication.form_handler' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     * 
     * @throws InactiveScopeException when the 'sonata.user.authentication.form_handler' service is requested while the 'request' scope is not active
     */
    protected function getSonata_User_Authentication_FormHandlerService()
    {
        ...
        return $this->services['sonata.user.authentication.form_handler'] = $this->scopedServices['request']['sonata.user.authentication.form_handler'] = new \FOS\UserBundle\Form\Handler\ProfileFormHandler($this->get('fos_user.profile.form'), $this->get('request'), $this->get('fos_user.user_manager'));
    }
    ...
    {
        return $this->services['sonata.user.editable_role_builder'] = new \Sonata\UserBundle\Security\EditableRolesBuilder($this->get('security.context'), $this->get('sonata.admin.pool'), array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'SONATA' => array()));
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Nucleus/HomeBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'/src/Nucleus/HomeBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Nucleus/HomeBundle/Resources/views'), 'NucleusHome');
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $b = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER', 1 => 'ROLE_SONATA_ADMIN'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN', 1 => 'ROLE_ALLOWED_TO_SWITCH'), 'SONATA' => array()));
    ...
    {
        return $this->services['validator.validator_factory'] = new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'sonata.core.validator.inline' => 'sonata.core.validator.inline', 'sonata.admin.validator.inline' => 'sonata.admin.validator.inline'));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'NucleusHomeBundle' => 'Nucleus\\HomeBundle\\NucleusHomeBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'mzounko',
            'database_user' => 'root',
            'database_password' => 'bescofab',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                ...
                2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/FOS/UserBundle/Resources/config/storage-validation/orm.xml'),
            ),
