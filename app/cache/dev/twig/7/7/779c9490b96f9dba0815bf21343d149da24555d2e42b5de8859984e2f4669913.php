...
class __TwigTemplate_779c9490b96f9dba0815bf21343d149da24555d2e42b5de8859984e2f4669913 extends Twig_Template
{
    ...
    <div class=\"container\">
        <h3 class=\"center\">";
        // line 52
        echo twig_escape_filter($this->env, twig_length_filter($this->env, (isset($context["annonces"]) ? $context["annonces"] : $this->getContext($context, "annonces"))), "html", null, true);
        echo " Offres en cours </h3>
      <dl class=\"dix_derniers\">
        ";
        // line 54
        $context['_parent'] = (array) $context;
        $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["annonces"]) ? $context["annonces"] : $this->getContext($context, "annonces"))));
        foreach ($context['_seq'] as $context["_key"] => $context["elt"]) {
            echo "  
            <dt>#00";
            // line 55
